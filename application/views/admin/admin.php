          ...
          <div class="row">
            <div class="col-xs-4">
              <div class="list-group">
                ...
                <li class="list-group-item" ng-repeat="bs in big_subjects"><a ng-click="bs_select(bs)" >{{bs.NAME}}</a><a onclick=""><button class="label label-warning pull-right">수정
                </button></li>
              </a>
            ...
            <ul class="list-group">
              <a href="#" class="list-group-item disabled text-center">
                ...
                <li class="list-group-item" ng-repeat="ss in small_subjects">
                  <a ng-click="ss_select(ss)">{{ss.NAME_KOR}}</a><a onclick=""><span class="label label-danger pull-right">초기화
          ...
          <div class="col-xs-4">
            <ul class="list-group">
              ...
              <li class="list-group-item" ng-repeat="person in people">
                {{person.NAME}}<a onclick=""><span class="label label-danger pull-right">삭제
              </span></a><a onclick=""><span class="label label-warning pull-right">수정
              </span></a>
            </li>
              <li class="list-group-item">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" ng-model="person_modal.url_address">
                  </div>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-default" data-dismiss="modal">닫기</button>
                  <button type="button" class="btn btn-primary" ng-click="add_person(person_modal)">저장</button>
                </div>
              </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
          </div><!-- /.modal -->
